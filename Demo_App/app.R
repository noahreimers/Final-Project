...
server <- function(input, output) {
  output$Plot <- renderPlot({
      ...
      # Generating the first plot that I listed the inputs for above and including a minor line of best fit.
  ...
  ## This is the code I used to print out the data point that the user clicks on.
  ...
  ## even though I could not achieve my end goal of being able to filter by both team and position.
